...
class LunenfeldServer{
    public static void main(String argv[]) throws Exception {
        String clientString;            // Stores incoming message
        String userInput;
        String[] clientStringArray;     // Stores array of clientString
        ...
        // Create input BufferedReader for user input
    ...
    public static List<String> runDistanceVectorAlgorithm(List<String> routingTableR1, List<String> routingTableR2){
        // Lists comes in as [destination1, distance1, neighborN,...,destinationN, distanceN, neighborN]
